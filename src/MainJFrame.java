...
public class MainJFrame extends javax.swing.JFrame {
    ...
    AlanAyarJFrame alanAyar = new AlanAyarJFrame(); 
    ...
    public MainJFrame() {
        ...
        Indicator = new Thread() {
            public void run() {
                while (true) {
                    //System.out.println(alanAyar.isShowing());
                    try {
                        Thread.sleep(20);
    ...
    private void alanOku() {
        ...
        jLabel_alan1.setText(db.alanlar.get(0));
        jLabel_alan2.setText(db.alanlar.get(1));
        jLabel_alan3.setText(db.alanlar.get(2));
        jLabel_alan4.setText(db.alanlar.get(3));
        jLabel_alan5.setText(db.alanlar.get(4));
        jLabel_alan6.setText(db.alanlar.get(5));
